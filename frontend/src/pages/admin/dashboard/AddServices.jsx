...
const AddServices = () => {
  ...
  return (
    ...
    <form className="add-service-form" onSubmit={handleSubmit}>
      ...
      <select name="service_category_id" required onChange={(e) => {
        const selected = serviceCategory.find(cat => cat.id.toString() === e.target.value);
      ...
      {serviceType === 'photosoot' && (
        <>
          ...
          <input type="text" name="photoshoot_name" onChange={handleChange} required />

          <label>Price</label>
          <input type="number" name="price" onChange={handleChange} required />

          <label>Duration</label>
          <input type="text" name="durarion" onChange={handleChange} required />
      ...
      {serviceType === 'printings' && (
        <>
          ...
          <input type="text" name="printing_name" onChange={handleChange} required />
      ...
      {serviceType === 'frame making' && (
        <>
          ...
          <input type="text" name="material_name" onChange={handleChange} required />
      ...
      <input type="file" name="photos" onChange={handleFileChange} multiple accept="image/*" required />

...
const EditServices = () => {
  ...
  const handleEdit = async (service) => {
    ...
    if (updateData) {
      ...
      const refreshed = await fetchServicesByCategoryId(
        service.serviceCategoryId
      );
      ...
      <div className="category-buttons d-flex flex-wrap mb-4 justify-content-center">
        {categories.map((cat) => (
          <button
            key={cat.id}
            variant={
              selectedCategoryId === cat.id ? "#f90348" : "outline-primary"
            }
            className="m-2"
                ...
                <tr key={service.serviceId}>
                  ...
                  {serviceType === "frame making" && (
                    <>
                      <td>
                        <Form.Control
                          defaultValue={service.frameSize}
                          onChange={(e) =>
                            handleChange(
                              service.frameSize,
                              "size",
                      ...
                      <td>
                        <Form.Control
                          defaultValue={service.framneColor}
                          onChange={(e) =>
                            handleChange(
                              service.framneColor,
                              "color",
                  ...
                  <td>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleChange(service.serviceId, "price", e.target.value)
                      }
                    />
                  </td>

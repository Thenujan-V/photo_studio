    ...
    <div className="container mt-1">
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        <Modal.Header closeButton>
          <Modal.Title>
            Send Message to {selectedFeedbacks?.username}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() =>
              handleSendReply(
                selectedFeedbacks?.mail,
                `Feedback response. your feedback - ${selectedFeedbacks?.feedback}`,
                message,
                selectedFeedbacks?.id
              )
            }
          >
            Send

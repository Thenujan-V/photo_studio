    ...
    <div className="sidebar">
      <nav className="sidebar-top">
        <div className="user mt-2">
          <div className="image">{user?.username?.charAt(0).toUpperCase()}</div>
          <div className="name">
        ...
        <NavLink to="/dashboard/live-orders" className="block">
          Live Orders
        </NavLink>
        <NavLink to="/dashboard/notifications" className="block">
          Notifications
        </NavLink>
        <NavLink to="/dashboard/change-mail" className="block">
          Change E-mail
        </NavLink>
        <NavLink to="/dashboard/change-password" className="block">
          Change Password
        </NavLink>
        <NavLink to="/dashboard/logout" className="block">
          Logout
        </NavLink>
      </nav>

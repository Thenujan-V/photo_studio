...
const ChangeMail = () => {
  ...
  return (
    ...
    <div className="edit-section">
        <h3>Change Email</h3>
        <p>You can update your email address here to ensure we have your most current contact information. Enter your new email address and click the submit button. An OTP will be sent to your new email for verification. Please enter the OTP to confirm the change and update your account.</p>
        ...
        <Modal.Body>
             <p>
                To confirm your email change, please enter the OTP sent to your new email address: <strong>{newEmail}</strong>. 
                This One-Time Password is required to verify your identity and confirm the update. 
                Check your inbox (and spam folder). Once you’ve entered the OTP, click <strong>"Verify & Change"</strong> to complete the email update.
            </p>
            <input
                type="text"
                value={otp}

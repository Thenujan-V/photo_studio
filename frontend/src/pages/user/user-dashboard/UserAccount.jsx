...
const UserAccount = () => {
  ...
  const handleSave = async () => {
    ...
    if (editData.username !== user.username && editData.username !== "")
      updatedFields.username = editData.username;
    if (editData.city !== user.city && editData.city !== "")
      updatedFields.city = editData.city;
    if (
      editData.phone_number !== user.phone_number &&
      editData.phone_number !== ""
    )
      updatedFields.phone_number = editData.phone_number;
        ...
        <div className="user-profile">
          ...
          <div className="user-fields">
            ...
            <input
              ...
              onChange={handleChange}
            />
            <button onClick={handleSave} style={{ marginTop: "35px" }}>
              Save Changes
            </button>
          </div>
        </div>
